...
const rootReducer = (state = initialState, action) => {
    switch (action.type) {
        ...
        case ADD_TO_CART:
            ...
            const existingCartItemIndex = findCartItemIndex(state.cart, addedProduct.id);
        ...
        case REMOVE_FROM_CART:
            ...
            const updatedCart = state.cart.filter((item) => item.id !== removedProductId);
            return { ...state, cart: updatedCart };
        case INCREASE_QUANTITY:
            const increasedProductId = action.payload;
            const increasedCartItemIndex = findCartItemIndex(state.cart, increasedProductId);
        ...
        case DECREASE_QUANTITY:
            ...
            const decreasedCartItemIndex = findCartItemIndex(state.cart, decreasedProductId);
